...
SECRET_KEY = 'django-insecure-s=he2s_2%0pkr%qmrb3qif=rm@v9(wgy9eajvro3o_ka21nfi$'
...
MIDDLEWARE = [
    ...
    'chats.middleware.RestrictAccessByTimeMiddleware',  # Time-based access restriction
